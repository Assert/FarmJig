...
function FarmJig(canvasID, rows, columns, mode) {
  ...
  FarmJig.registerTouchEvents = registerTouchEvents;
  ...
  FarmJig.calcHeightFromReference = calcHeightFromReference;
  function calcHeightFromReference(p) {
    var refHeight = 577;
    return Math.round(p / refHeight * FarmJig.ctx.canvas.height) + "px";
  }

  FarmJig.calcWidthFromReference = calcWidthFromReference;
  function calcWidthFromReference(p) {
    var refWidth = 962;
    return Math.round(p / refWidth * FarmJig.ctx.canvas.width) + "px";
  }

  FarmJig.startPuzzle = startPuzzle;
  ...
  FarmJig.makeBoardSlotsAndPieces = makeBoardSlotsAndPieces;
  function makeBoardSlotsAndPieces() {
    for (var i = 0; i < FarmJig.numberOfPieces(); i++) {
      var piece = FarmJig.makePuzzlePiece(i);
      FarmJig.pieceList.push(piece);

      var slot = FarmJig.makeBoardSlot(i);
  ...
  FarmJig.updateScreen = updateScreen;
  ...
  FarmJig.updateAllNonSelectedPieces = updateAllNonSelectedPieces;
  function updateAllNonSelectedPieces() {
  ...
  FarmJig.handleOnMouseDown = handleOnMouseDown;
  ...
  FarmJig.handleOnMouseMove = handleOnMouseMove;
  ...
  FarmJig.checkIfWeHoverRightSlot = checkIfWeHoverRightSlot;
  function checkIfWeHoverRightSlot() {
  ...
  FarmJig.findPossibleStartSlots = findPossibleStartSlots;
  function findPossibleStartSlots() {
    var arr = [];
  ...
  FarmJig.makeBoardSlot = makeBoardSlot;
  function makeBoardSlot(index) {
  ...
  FarmJig.findSelectedPuzzlePiece = findSelectedPuzzlePiece;
  function findSelectedPuzzlePiece(x, y) {
  ...
  FarmJig.drawSection = drawSection;
  function drawSection(piece, pieceWidthOnScreen, pieceHeightOnScreen) {
    FarmJig.ctx.save();
  ...
  FarmJig.drawPreviewPicture = drawPreviewPicture;
  function drawPreviewPicture() {
    FarmJig.ctx.save();
  ...
  FarmJig.drawBackGround = drawBackGround;
